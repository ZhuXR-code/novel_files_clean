package com.bookscleanandroid.app
...
import com.bookscleanandroid.app.ui.screens.privacy.PrivacyPolicyScreen
...
import com.bookscleanandroid.app.ui.navigation.NavRoutes
import com.bookscleanandroid.app.ui.navigation.NavRoutes.configEdit
import com.bookscleanandroid.app.ui.screens.cleanup.OneClickCleanupScreen
import com.bookscleanandroid.app.ui.screens.config.ConfigEditScreen
import com.bookscleanandroid.app.ui.screens.config.ConfigListScreen
import com.bookscleanandroid.app.ui.screens.delete.DeleteConfirmScreen
import com.bookscleanandroid.app.ui.screens.delete.DeleteProgressScreen
import com.bookscleanandroid.app.ui.screens.help.HelpScreen
import com.bookscleanandroid.app.ui.screens.home.HomeScreen
import com.bookscleanandroid.app.ui.screens.home.ScanProgressScreen
import com.bookscleanandroid.app.ui.screens.library.LibraryScreen
import com.bookscleanandroid.app.ui.screens.library.FileDetailScreen
import com.bookscleanandroid.app.ui.screens.library.FilePreviewScreen
import com.bookscleanandroid.app.ui.screens.settings.SettingsScreen
import com.bookscleanandroid.app.ui.screens.settings.KeywordReplaceScreen
import com.bookscleanandroid.app.ui.screens.settings.LogViewerScreen
import com.bookscleanandroid.app.ui.screens.settings.DupRuleConfigScreen
import com.bookscleanandroid.app.data.model.ScanStateManager
import com.bookscleanandroid.app.service.ScanService
import com.bookscleanandroid.app.ui.theme.FileScannerTheme
...
fun AppNavigation() {
    ...
    val prefs = (appContext.applicationContext as FileScannerApp).preferencesUtil
    val scope = rememberCoroutineScope()
    var privacyAgreed by remember { mutableStateOf<Boolean?>(null) }
    LaunchedEffect(Unit) { scope.launch { privacyAgreed = prefs.privacyAgreed.first() } }
    ...
    if (privacyAgreed == false) {
        PrivacyPolicyScreen(
            showActions = true,
            onAgree = { scope.launch { prefs.setPrivacyAgreed(true); privacyAgreed = true } },
            onDisagree = { (appContext as? ComponentActivity)?.finish() }
        )
        return
    }
